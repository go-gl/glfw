...
static void null_window_acquireMonitor(_GLFWwindow* window)
{
    _glfwInputMonitorWindow(window->monitor, window);
}

static void null_window_releaseMonitor(_GLFWwindow* window)
{
...
static int null_window_createNativeWindow(_GLFWwindow* window,
...
GLFWbool _glfwCreateWindowNull(_GLFWwindow* window,
                               ...
                               const _GLFWfbconfig* fbconfig)
{
    if (!null_window_createNativeWindow(window, wndconfig, fbconfig))
        return GLFW_FALSE;
...
{
    if (window->monitor)
        null_window_releaseMonitor(window);
