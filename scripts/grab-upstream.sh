...
# v3.4
{
  v34rev="$(cat v3.4/glfw/GLFW_C_REVISION.txt)"
  scripts/generate-buildable-source-code.sh "v3.4" "$v34rev"
  # Strip wayland-scanner versions to prevent dirty git trees.
  sed -i 's|/\* Generated by wayland-scanner .* \*/|/* Generated by wayland-scanner */|' \
    ./v3.4/glfw/glfw/include/*-protocol.h ./v3.4/glfw/glfw/include/*-protocol-code.h 2>/dev/null || true
